...
object Main extends App {
  val tag1 = new TagUuid(Tag1)  // q: `def` allows multiple uuids to be generated for one object?
  val tag2 = new TagUuid(Tag2)  // a: 'val' for immutable vars, `def` for function evaluated on each call
